...
def create_intensity_frame(parent, config: BarcodeConfigGUI):
    ...
    # Add info box
    create_popup(frame, "Select starting frame of the video. Determines portion of video that the intensity distribution is calculated over.", row_c, first_frame_label)
    ...
    # Add info box
    create_popup(frame, "Select ending frame of the video. Determines portion of video that the intensity distribution is calculated over.", row_c, last_frame_label)
    ...
    # Add info box
    create_popup(frame, "Controls fraction of frames evaluated from first to last selected. Decreasing this value increases speed of branch while decreasing compared periods (useful to narrow in on specific behavior). Increasing value decreases processing speed while increasing precision of metrics over a larger period.", row_c, pf_eval_label)
