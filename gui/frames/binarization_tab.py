...
def create_binarization_frame(
    ...
    create_popup(frame, "Changes cutoff threshold for binarization. Decreasing threshold can increase noise, while increasing threshold can lead to lost features. Use viewer to determine optimal value for sample.", row_b, binarization_label)
    ...
    frame_step_label=tk.Label(frame, text="Frame Step (res_f_step) [min=1]:")
    ...
    create_popup(frame, "Changes interval (in frames) between binarized frames. Affects speed of program, with larger intervals decreasing program runtime.", row_b, frame_step_label)
    ...
    # Add popup for frame start percent
    create_popup(frame, "Change window over which binarization metrics are calculated. By default, BARCODE compares metrics for the first 5 percent of the video to the last 10 percent of the video, calculating percentage change. Changing Frame Start Percent and Frame Stop Percent allow shifting and scaling of the second portion to narrow in on smaller periods or investigate behavior at earlier periods. Frame Start determines beginning of second portion.", row_b, pf_start_label)    
    ...
    create_popup(frame, "Change window over which binarization metrics are calculated. By default, BARCODE compares metrics for the first 5 percent of the video to the last 10 percent of the video, calculating percentage change. Changing Frame Start Percent and Frame Stop Percent allow shifting and scaling of the second portion to narrow in on smaller periods or investigate behavior at earlier periods. Frame Start determines end of second portion.", row_b, pf_stop_label) 
